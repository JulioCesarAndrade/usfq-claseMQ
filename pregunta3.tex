\question [20] Una partícula puntual de masa $m$ y carga $q$ se mueve en un ambiente espacialmente uniforme de campo eléctrico y magnético cruzados $\vec{B} =B_0\hat{z}$ y $\vec{E}=E_0\hat{x}$
\begin{parts}
